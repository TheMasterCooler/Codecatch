	...
	namespace Lua
	{
		...
		public:
			...
			*/
			...
			virtual bool			GetMetaTable(int iStackPos, const char* metaTable) = 0;
			...
			virtual int				PushAngle(void* const&) = 0;
			virtual int				PushVector(void* const&) = 0;
			...
			virtual void*				RunString(const char*, const char*, const char*, bool, bool) = 0; // 92
			...
			virtual int				MsgColour(const void*&, const char*, ...) = 0;
